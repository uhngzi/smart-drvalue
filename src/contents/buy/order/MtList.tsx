...
import { materialGroupBadType, materialGroupType, materialPriceType } from "@/data/type/base/material_back";
...
interface Props {
  ...
  setSelectMtIdx:(value: SetStateAction<{
      mtIdx: string;
      orderId: string;
      orderNo: number;
    } | null>
...
const MtList:React.FC<Props> = ({
  ...
  return (
    <>
      <Popup title={step === 1 || step === 3 ? "발주 품목" : "품질 검사"}
        titleEtc={<div className="h-center flex-1 justify-end gap-8">
          { step > 1 &&
            ...
            <Items2
              ...
              children1={
                <AntdSelectFill
                  ...
                  placeholder="원자재 그룹" styles={{ht:'32px', bg:'#FFF', br: '2px'}} readonly={read}
                />
              }
            />
            ...
            <Items2
              ...
              children1={
                ...
                <AntdSelect
                  ...
                  placeholder="원자재 선택" styles={{ht:'32px', bg:'#FFF', br: '2px'}} readonly={read}
                />
              }
            />
            ...
            <Items2
              ...
              children1={
                <AntdInput
                  ...
                  type="number" placeholder="W 입력" readonly={read}
                />
              }
            />
            ...
            <Items2
              ...
              children1={
                <AntdInput
                  ...
                  type="number" placeholder="H 입력" readonly={read}
                />
              }
            />
            ...
            <Items2
              ...
              children1={
                <AntdInput
                  ...
                  type="number" placeholder="무게 입력" readonly={read}
                />
              }
            />
            ...
            <Items2
              ...
              children1={
                <AntdInput
                  ...
                  type="number" placeholder="수량 입력" readonly={read}
                />
              }
            />
            ...
            <Items2
              ...
              children1={
                <AntdInput
                  ...
                  type="number" placeholder="단가 입력" readonly={read}
                />
              }
            />
            ...
            <Items2
              ...
              children1={
                <AntdInput
                  ...
                  type="number" placeholder="금액 입력" readonly={read}
                />
              }
            />
            { step === 1 &&
          ...
          <div className="flex items-start gap-20">
            <div className="flex-1">
              <AntdTableEdit
                ...
                data={mtBad.filter(f=>f.materialGroup?.id === item.materialGrpIdx)}
                styles={subTableStyles}
              />
            </div>
