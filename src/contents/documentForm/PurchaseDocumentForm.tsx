    ...
    return (
        ...
        <table className="table-fixed border border-[#D9D9D9] text-center text-[9px] font-[Spoqa Han Sans Neo] w-[270px]">
            <tbody>
                ...
                <td rowSpan={3} className="w-[20px] border border-[#D9D9D9] align-middle">
                결<br />재
                </td>
                ...
                <table className="table-auto w-full border-t border-[#D9D9D9]">
                        <tbody className="font-[Spoqa Han Sans Neo] text-[9px] font-style:normal">
                            <tr className="border-b border-[#D9D9D9] h-[25px]">
                                <td className="w-[50px] pl-[8px] bg-[rgba(238,238,238,0.5)] ">발주 번호</td>
                                <td colSpan={3} className="max-w-[75px] pl-[8px] pt-[5px]"></td>
                                </tr>
            
                            <tr className="border-b border-[#D9D9D9] h-[25px]">
                                <td className="pl-[8px] bg-[rgba(238,238,238,0.5)] ">발주 금액</td>
                                <td colSpan={3} className="max-w-[75px] pl-[8px]"></td>
                                </tr>
                                
                                <tr className="border-b border-[#D9D9D9] h-[25px]">
                                <td className="w-[75px] pl-[8px] bg-[rgba(238,238,238,0.5)] whitespace-nowrap">발주 일자</td>
                                <td className="max-w-[120px] pl-[8px] whitespace-nowrap">1</td>
                                <td className="w-[75px] pl-[8px] bg-[rgba(238,238,238,0.5)] whitespace-nowrap">납품 장소</td>
                                <td className="max-w-[120px] pl-[8px] whitespace-nowrap">2</td>
                            </tr>
                
                            <tr className="border-b border-[#D9D9D9] h-[25px]">
                                <td className="w-[75px] pl-[8px] bg-[rgba(238,238,238,0.5)] whitespace-nowrap">담당 부서</td>
                                <td className="max-w-[120px] pl-[8px] whitespace-nowrap">1</td>
                                <td className="w-[75px] pl-[8px] bg-[rgba(238,238,238,0.5)] whitespace-nowrap">담당자</td>
                                <td className="max-w-[120px] pl-[8px] whitespace-nowrap">2</td>
                            </tr>
                
                            <tr className="border-b border-[#D9D9D9] h-[25px]">
                                <td className="w-[75px] pl-[8px] bg-[rgba(238,238,238,0.5)] whitespace-nowrap">전화번호</td>
                                <td className="max-w-[120px] pl-[8px] whitespace-nowrap">1</td>
                                <td className="w-[75px] pl-[8px] bg-[rgba(238,238,238,0.5)] whitespace-nowrap">팩스번호</td>
                                <td className="max-w-[120px] pl-[8px] whitespace-nowrap">2</td>
                            </tr>
                            </tbody>
                        </table>
        ...
        <table className="table-auto w-full border-t border-[#D9D9D9]"> 
            ...
            <tr className="border-b border-[#D9D9D9] h-[25px]">
            <td rowSpan={5} className="w-[30px] border border-[#D9D9D9] bg-[#E9EDF5] pl-[10px]">
                발<br />주<br />서
            </td>
    ...
    <div className= "w-full h-[445px] ">
        <table className="h-[25px] table-auto w-full border-t border-[#D9D9D9]">
            ...
            <tbody className="mb-0 font-[Spoqa Han Sans Neo] text-[9px] font-style:normal bg-[rgba(238,238,238,0.5)]">
                ...
                <td className="border-r border-[#D9D9D9] w-[342px] h-[25px] px-[8px] ">품명</td>
                <td className="border-r border-[#D9D9D9] w-[70px] h-[25px] px-[8px] ">납기</td>
                <td className="border-r border-[#D9D9D9] w-[100px] h-[25px] px-[8px] ">규격</td>
                <td className="border-r border-[#D9D9D9] w-[70px] h-[25px] px-[8px] ">소재명</td>
            ...
            <tbody className="font-[Spoqa Han Sans Neo] text-[9px] font-style:normal text-center align-middle ">
                ...
                <tr key={index} className="border-b border-[#D9D9D9] h-[20px] text-[#000000A6]">
                ...
                <td className="border-r border-[#D9D9D9] px-[8px]" colSpan={5}><span className='px-[30px]'>합</span><span>계</span></td>
                <td className="border-r border-[#D9D9D9] px-[8px]">160</td>
                <td className="border-r border-[#D9D9D9] px-[8px] text-right">-</td>
                <td className="border-r border-[#D9D9D9] px-[8px] text-right">-</td>
                </tr>

                {/* 빈 줄 */}
                {Array.from({ length: Math.max(0, 11 - sample.length - 1) }, (_, index) => (
                <tr key={`empty-${index}`} className="border-b border-[#D9D9D9] h-[20px]">
                    {Array.from({ length: 8 }).map((_, colIdx) => (
                    <td 
                    key={colIdx} className={`px-[8px] ${colIdx !== 7 ? 'border-r border-[#D9D9D9]' : ''}`}>&nbsp;
                    </td>
                    ))}
                </tr>
                ))}
