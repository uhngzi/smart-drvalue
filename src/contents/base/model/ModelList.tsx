...
const ModelList: React.FC<Props> = ({
  ...
  const handleSelectMenu = () => {
    ...
    if (selectRecord !== null && products) {
      if (type === "order") {
        ...
        if (index > -1) {
          newData[index] = {
            ...
            modelStatus:
              selectMenuKey === 1 ? ModelStatus.REPEAT : ModelStatus.MODIFY,
      ...
      if (!productChk) setDrawerOpen?.(false);
    }
  };
    ...
    <div className="flex flex-col gap-20">
      ...
      <AntdAlertModal
                  ...
                  .map((p) => (
                    <Radio.Button
                      ...
                      onClick={(e) => {
                        ...
                        if (type === "match" && (p as orderModelType).editModel)
                          setProductChk(true);
                        // 고객 발주에서 해당 모델에 입력된 값이 있을 경우
                        else if (type === "order" && p.currPrdInfo)
                          setProductChk(true);
                      }}
        ...
        onOk={() => {
          ...
          if (selectP) {
            if (
              selectP.modelStatus === ModelStatus.REPEAT &&
              selectMenuKey === 0
            ) {
              ...
              selectP.modelStatus === ModelStatus.MODIFY &&
              selectMenuKey === 1
            ) {
