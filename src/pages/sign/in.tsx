...
const gradientStyle = {
  background:
    "linear-gradient(91.55deg, #4880FF 12%, #03C75A 30%, #038D07 100%)",
  ...
  return (
    <div className="w-[400px] flex flex-col gap-40 justify-center min-h-[300px]">
      <div className="flex flex-col gap-5 h-center">
        <span
          className="font-bold leading-[26px] tracking-[-0.16px]"
          style={{ color: "#999999" }}
        >
          무한 성장을 위한 확장이 필수인 시대,
        </span>
        <span
          className="leading-[1.2] tracking-[-0.32px]"
          style={gradientStyle}
        >
          GrowX
        </span>
      ...
      <div className="flex flex-col gap-10">
        <div
          className="pl-18 flex gap-20 h-center rounded-8 h-[56px]"
        ...
        <Button
          ...
          style={{
            background:
              "linear-gradient(91.71deg, #4880FF -11.85%, #03C75A 70.39%, #038D07 111.82%)",
          }}
        >
          <span>로그인하기</span>
        </Button>
