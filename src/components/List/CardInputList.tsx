  ...
  return (
    ...
    >
      ...
      <section className="rounded-lg border border-[#D9D9D9]">
              ...
              >
                    ...
                    <AntdInput
                      ...
                      onChange={(e) => {
                        ...
                        if (item.name === "prtRegCd") {
                          ...
                          ).find((f) => f.prtRegCd === Number(e.target.value));
                  ...
                  {item.type === "date" && (
                    <AntdDatePicker
                      ...
                      onChange={(e: Date | null) =>
                        handleDataChange(
                          dayjs(e).startOf("day").format("YYYY-MM-DDTHH:mm:ss"),
                          item.name,
                          "date"
                        )
                      }
                ...
                {item.value ? (
                  ...
                  item.name.toLowerCase().includes("email") &&
                    !isValidEmail(item?.value?.toString()) ? (
                    <div className="h-center gap-3 text-[red]">
                      <p className="w-15 h-15">
                        <Hint />
                      </p>
                  ...
                  (item.name.toLowerCase().includes("enm") ||
                      item.name.toLowerCase().includes("eng")) &&
                    !isValidEnglish(item?.value?.toString()) ? (
                    <div className="h-center gap-3 text-[red]">
                      <p className="w-15 h-15">
                        <Hint />
                      </p>
        ...
        {innerBtnContents && (
          <div className="w-full pt-20 flex justify-end">
            {innerBtnContents}
          </div>
        )}
      </section>
